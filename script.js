...
document.querySelectorAll('.skill-category, .project-card, .achievement-category, .highlight').forEach(el => {
    el.style.opacity = '0';
    ...
    entries.forEach(entry => {
        if (entry.isIntersecting) {
            ...
            stats.forEach(stat => {
                ...
                if (value) {
                    animateCounter(stat, parseInt(value[0]));
                }
            });
...
console.log(`
%c👋 Hello there! %c
%cWelcome to Muhammad Usman's Portfolio
%c🔬 Medical Student | 💻 Tech Enthusiast | 🔐 Cybersecurity Researcher
%cFeel free to explore and connect!
%c📧 muhammadusman.cims@gmail.com
%c🔗 github.com/Usman0220
`,
